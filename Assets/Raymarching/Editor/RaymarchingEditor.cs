...
public class RaymarchingEditor : Editor {
	...
	SerializedProperty noiseCubemapResolution;
	SerializedProperty noiseCubemapFrequency;
	SerializedProperty heatMap;

	SerializedProperty stereoSeparationFactor;

	SerializedProperty alpha;
	SerializedProperty alphaDecay;
	...
	SerializedProperty shadowMaxSteps;
    ...
    {	
		...
		noiseCubemapFrequency = serializedObject.FindProperty("noiseCubemapFrequency");
		noiseCubemapResolution = serializedObject.FindProperty("noiseCubemapResolution");
		...
		alphaDecay = serializedObject.FindProperty("alphaDecay");
    ...
    public override void OnInspectorGUI()
    {
		...
		}else if (tabs == 1)
		{
			...
			EditorGUILayout.PropertyField(alphaDecay);
